...
const GITHUB_RELEASES = 'https://github.com/cispl-dev/emark/releases';
const GITHUB_REPO = 'https://github.com/cispl-dev/emark';
const SOURCEFORGE_PROJECT = 'https://sourceforge.net/projects/emark/';
const SOURCEFORGE_REVIEWS = 'https://sourceforge.net/projects/emark/reviews/';
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <h3 className="font-semibold text-white text-sm mb-1">
                        {downloadSource === 'github'
                          ? "Enjoying eMark? Star us on GitHub!"
                          : "Love eMark? Leave a review!"}
                      </h3>
                      <p className="text-xs text-slate-400 leading-relaxed">
                        {downloadSource === 'github'
                          ? "Your star helps others discover eMark and motivates our development. It only takes a second!"
