 ...
 *
 * Centralized constants for the eMark website.
 * eMark is a product of TrexoLab.
 */
...
export const ORG = {
  ...
  github: 'https://github.com/cispl-dev',
  email: 'contact@trexolab.com',
} as const;

// Product URLs (eMark)
export const GITHUB_URL = 'https://github.com/cispl-dev/emark';
export const RELEASES_URL = 'https://github.com/cispl-dev/emark/releases';
export const WIKI_URL = 'https://github.com/cispl-dev/emark/wiki';
export const ISSUES_URL = 'https://github.com/cispl-dev/emark/issues';
...
export const LICENSE = {
  name: 'AGPL-3.0',
  url: 'https://github.com/cispl-dev/emark/blob/main/LICENSE',
} as const;
