...
export function Installation() {
  ...
  const installationStructuredData = structuredDataGenerators.howTo(
    'How to Install eMark PDF Signing Software',
    'Complete step-by-step guide to install eMark on Windows, macOS, and Linux. Includes Java 8 setup, certificate configuration, and troubleshooting tips.',
    [
  ...
  const breadcrumbStructuredData = structuredDataGenerators.breadcrumb([
    { name: 'Home', url: 'https://cispl-dev.github.io/emark/' },
    { name: 'Installation Guide', url: 'https://cispl-dev.github.io/emark/#/installation' },
  ]);

  return (
    <>
      <SEO
        title="Installation Guide - How to Install eMark"
        description="Complete installation guide for eMark PDF signing software. Step-by-step instructions for Windows, macOS, and Linux. Learn how to set up Java 8, configure certificates, and start signing PDFs."
        keywords="eMark installation, install PDF signer, Windows PDF signing setup, Linux PDF signer install, macOS PDF signing, Java 8 setup, PKCS#12 configuration, digital certificate setup, USB token signing setup"
        url="https://cispl-dev.github.io/emark/#/installation"
        image="https://cispl-dev.github.io/emark/images/setting-keystore.png"
          ...
          <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-8">
            <div className="flex-1">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mb-6">
                Get started with eMark in minutes. Follow our step-by-step instructions
            ...
            <div className="glass-card-premium p-6 lg:min-w-[320px]">
              ...
              <a href="https://github.com/cispl-dev/emark/releases/latest" target="_blank" rel="noopener noreferrer">
        ...
        <div className="flex gap-8 relative">
          ...
          <main className="flex-1 min-w-0 space-y-16">
              ...
              <div className="glass-card p-6">
                ...
                <div className="space-y-8">
                  <Step number={1} title="Download the Installer">
                    ...
                    <a href="https://github.com/cispl-dev/emark/releases/latest/download/emark-x64-setup.exe">
                      <Button className="gap-2 btn-gradient text-white border-0 cursor-pointer-custom">
                        <Download className="w-4 h-4" />
                        Download emark-x64-setup.exe
                      </Button>
                    </a>
                  </Step>
                  ...
                  <Step number={3} title="Launch eMark">
                    ...
                    <ul className="mt-2 space-y-1 text-xs text-muted-foreground">
                      <li>• <strong>eMark</strong> - Normal (2GB)</li>
                      <li>• <strong>eMark (Large)</strong> - Large (4GB)</li>
                      <li>• <strong>eMark (Extra Large)</strong> - Extra Large (8GB)</li>
                    </ul>
                  </Step>
                </div>
              </div>
                ...
                {linuxTab === 'ubuntu' && (
                  <div className="space-y-8">
                    ...
                    <Step number={1} title="Download and Install .deb Package">
                      <CodeBlock code={`wget https://github.com/cispl-dev/emark/releases/latest/download/emark-x64.deb\nsudo dpkg -i emark-x64.deb`} />
                    </Step>
                    <Step number={2} title="Launch eMark">
                      <p className="text-muted-foreground">
                        Run from terminal or find "eMark" in your applications menu:
                      </p>
                ...
                {linuxTab === 'fedora' && (
                  <div className="space-y-8">
                    ...
                    <Step number={2} title="Download the JAR File">
                      <CodeBlock code="wget https://github.com/cispl-dev/emark/releases/latest/download/eMark.jar" />
                    </Step>
                    <Step number={3} title="Run eMark">
                      <CodeBlock code="java -jar eMark.jar" />
                    </Step>
                  </div>
                )}
                ...
                {linuxTab === 'generic' && (
                  <div className="space-y-8">
                    ...
                    <Step number={2} title="Download JAR File">
                      <a href="https://github.com/cispl-dev/emark/releases/latest/download/eMark.jar">
              ...
              <div className="glass-card p-6">
                ...
                <div className="space-y-8">
                  <Step number={1} title="Download the DMG Installer">
                    ...
                    <a href="https://github.com/cispl-dev/emark/releases/latest/download/emark-x64-macos.dmg">
                      <Button className="gap-2 btn-gradient text-white border-0 cursor-pointer-custom">
                        <Download className="w-4 h-4" />
                        Download emark-x64-macos.dmg
                      </Button>
                    </a>
                  </Step>
                  <Step number={2} title="Install the Application">
                    <p className="text-muted-foreground">
                      Open the downloaded DMG file and drag eMark to your Applications folder.
                    </p>
                  </Step>
                  <Step number={3} title="Launch eMark">
                    <p className="text-muted-foreground">
                      Open eMark from your Applications folder or Spotlight.
                    </p>
                ...
                <div className="mt-6 p-4 rounded-xl bg-white/5 border border-white/10">
                  ...
                  <CodeBlock code="java -jar eMark.jar" className="mt-3" />
                </div>
              </div>
            </AnimatedSection>
            ...
            <AnimatedSection id="first-run" className="scroll-mt-24" threshold={0.1}>
              ...
              <div className="glass-card p-6">
                <div className="space-y-8">
                  <Step number={1} title="Launch eMark">
                    <p className="text-muted-foreground">
                      Start eMark from your applications menu, desktop shortcut, or terminal.
                    </p>
                  </Step>
                  ...
                  <Step number={3} title="Open a PDF Document">
                    <p className="text-muted-foreground">
                      Open a PDF file using <strong>File → Open</strong> or simply drag and drop a PDF onto the eMark window.
                    </p>
                  </Step>
            ...
            <AnimatedSection id="uninstall" className="scroll-mt-24" threshold={0.1}>
              ...
              <div className="glass-card p-6 space-y-6">
                <p className="text-muted-foreground">
                  Follow these instructions to completely remove eMark and all associated data from your system.
                </p>
                ...
                <div className="space-y-4">
                  ...
                  <div className="ml-13 space-y-4">
                    ...
                    <Step number={3} title="Remove Registry Entries (Optional)">
                      ...
                      <CodeBlock code={`HKEY_CURRENT_USER\\Software\\eMark\nHKEY_LOCAL_MACHINE\\SOFTWARE\\eMark`} />
                    </Step>
                  </div>
                </div>
                  ...
                  <div className="ml-13 space-y-4">
                    <Step number={1} title="Remove Application">
                      ...
                      <ul className="space-y-1 text-sm text-muted-foreground">
                        ...
                        <li>• Right-click on <strong>eMark</strong> → <strong>Move to Trash</strong></li>
                        <li>• Empty Trash to complete removal</li>
                      </ul>
                      <p className="text-sm text-muted-foreground mt-3">
                        <strong>Or via Terminal:</strong>
                      </p>
                      <CodeBlock code="sudo rm -rf /Applications/eMark.app" className="mt-2" />
                    </Step>
                    <Step number={2} title="Remove User Data (Optional)">
                      <p className="text-muted-foreground mb-3">
                        Delete configuration and cache files:
                      </p>
                      <CodeBlock code={`rm -rf ~/.eMark\nrm -rf ~/Library/Application\\ Support/eMark\nrm -rf ~/Library/Caches/eMark\nrm -rf ~/Library/Preferences/com.trexalab.emark.plist`} />
                    </Step>
                  </div>
                </div>
                ...
                <div className="space-y-4 pt-6 border-t border-white/10">
                  ...
                  <div className="ml-13">
                    ...
                    <ul className="space-y-2 text-sm text-muted-foreground">
                      <li>1. Delete the <code className="code-inline">eMark.jar</code> file</li>
                ...
                <div className="flex items-start gap-4 p-4 rounded-xl bg-blue-500/10 border border-blue-500/20">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      ...
                      <strong>Note:</strong> Your signed PDF files are NOT affected by uninstalling eMark.
                    </p>
                  </div>
                </div>
              </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-3">
                        <a
                          href="https://github.com/cispl-dev/emark/wiki"
                        ...
                        <a
                          href="https://github.com/cispl-dev/emark/issues"
