...
export function Home() {
  ...
  const structuredData = [
    ...
    structuredDataGenerators.breadcrumb([
      ...
      { name: 'Download', url: 'https://cispl-dev.github.io/emark/#download' },
      { name: 'Features', url: 'https://cispl-dev.github.io/emark/#features' },
    ]),
  ];
