...
export function Diagrams() {
  ...
  const imageGalleryStructuredData = structuredDataGenerators.imageGallery(
    diagrams.map((d) => ({
      url: `https://cispl-dev.github.io/emark${d.src}`,
      title: d.title,
  ...
  const breadcrumbStructuredData = structuredDataGenerators.breadcrumb([
    ...
    { name: 'Architecture Diagrams', url: 'https://cispl-dev.github.io/emark/#/diagrams' },
  ]);

  const techArticleStructuredData = structuredDataGenerators.techArticle(
    'eMark Architecture Diagrams - System Design Documentation',
    'Technical architecture diagrams for eMark PDF signing software. Includes system architecture, workflow diagrams, component interaction, and sequence diagrams.',
    'https://cispl-dev.github.io/emark/diagrams/System_Architecture_Diagram.svg'
  );
  ...
  return (
    <>
      <SEO
        ...
        description="Explore eMark technical architecture and workflow diagrams. System design documentation including component interaction, sequence diagrams, and PDF signing workflow."
        keywords="eMark architecture, system design, technical diagrams, PDF signing workflow, component diagram, sequence diagram, software architecture, UML diagrams"
        url="https://cispl-dev.github.io/emark/#/diagrams"
        image="https://cispl-dev.github.io/emark/diagrams/System_Architecture_Diagram.svg"
