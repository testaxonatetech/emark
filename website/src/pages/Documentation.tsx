...
export function Documentation() {
  ...
  const breadcrumbStructuredData = structuredDataGenerators.breadcrumb([
    ...
    { name: 'Documentation', url: 'https://cispl-dev.github.io/emark/#/documentation' },
  ]);

  return (
    <>
      <SEO
        title="Documentation - eMark PDF Signing Software"
        description="Complete documentation for eMark PDF signing software. Learn about digital certificates, PKCS#11 tokens, signature standards, timestamping, and security features."
        keywords="eMark documentation, PDF signing guide, digital certificate tutorial, PKCS#11 guide, PAdES signatures, RFC 3161 timestamp, USB token signing"
        url="https://cispl-dev.github.io/emark/#/documentation"
