@echo off
REM ============================================================================
REM eMark - Launcher Script for Windows (x86/32-bit)
REM TrexoLab - https://trexolab.com
REM ============================================================================
REM
REM This script launches eMark with the bundled JRE 8 x86 (32-bit).
...
REM ============================================================================
set "JAR_FILE=!SCRIPT_DIR!\eMark.jar"
...
echo.
echo  Please reinstall eMark to restore the Java runtime.
echo.
echo ============================================================================
pause
endlocal
