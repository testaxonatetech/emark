' ============================================================================
' eMark - Silent Launcher (VBScript)
' TrexoLab - https://trexolab.com
' ============================================================================
'
' This script launches eMark without showing a command window.
' It is used for file associations and shortcuts to display "eMark"
