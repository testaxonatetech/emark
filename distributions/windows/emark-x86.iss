; ============================================================================
; eMark - Windows x86 (32-bit) Installer Script
; Inno Setup 6.x Script
; TrexoLab - https://trexolab.com
; ============================================================================
;
; This installer packages:
; - eMark.jar (the main application)
...
#define MyAppURL "https://cispl-dev.github.io/emark/"
...
; Per-user: C:\Users\<user>\AppData\Local\Programs\TrexoLab\eMark
; Per-machine: C:\Program Files (x86)\TrexoLab\eMark
DefaultDirName={autopf32}\TrexoLab\eMark
...
[Components]
Name: "main"; Description: "eMark Application"; Types: full compact custom; Flags: fixed
...
Source: "..\..\target\eMark.jar"; DestDir: "{app}"; Flags: ignoreversion; Components: main
...
Name: "{group}\{#MyAppName}"; Filename: "wscript.exe"; Parameters: """{app}\{#MyAppLauncher}"""; WorkingDir: "{app}"; IconFilename: "{app}\logo.ico"; Comment: "Launch eMark (Normal - 2GB)"

; Start Menu - Large profile
Name: "{group}\{#MyAppName} (Large)"; Filename: "wscript.exe"; Parameters: """{app}\{#MyAppLauncher}"" large"; WorkingDir: "{app}"; IconFilename: "{app}\logo.ico"; Comment: "Launch eMark (Large - 4GB)"

; Start Menu - Extra Large profile
Name: "{group}\{#MyAppName} (Extra Large)"; Filename: "wscript.exe"; Parameters: """{app}\{#MyAppLauncher}"" xlarge"; WorkingDir: "{app}"; IconFilename: "{app}\logo.ico"; Comment: "Launch eMark (Extra Large - 8GB)"

; Start Menu - Uninstall shortcut
Name: "{group}\Uninstall {#MyAppName}"; Filename: "{uninstallexe}"; Comment: "Uninstall eMark"
...
begin
  ...
  begin
    Log('eMark (32-bit) installation completed successfully.');
