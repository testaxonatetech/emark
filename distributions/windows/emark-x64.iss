; ============================================================================
; eMark - Windows x64 Installer Script
...
; Per-machine: C:\Program Files\TrexoLab\eMark
DefaultDirName={autopf}\TrexoLab\eMark
...
begin
  ...
  begin
    Log('eMark installation completed successfully.');
