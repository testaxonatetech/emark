#!/bin/bash
# ============================================================================
# eMark - macOS Diagnostic Script
# TrexoLab - https://trexolab.com
# ============================================================================
#
# This script diagnoses issues with the eMark macOS app installation.
...
#   ./diagnose-app.sh "eMark Large.app"
#
# ============================================================================

set -e

APP_NAME="${1:-eMark.app}"
APP_PATH="/Applications/$APP_NAME"

echo "============================================================================"
echo " eMark Diagnostic Tool"
echo "============================================================================"
echo " App: $APP_NAME"
echo "============================================================================"
echo ""
...
if [ ! -d "$APP_PATH" ]; then
    ...
    echo ""
    echo "   Available eMark apps in /Applications:"
...
# Check for JAR file
echo "4. Checking for eMark.jar..."
JAR_FILE="$RESOURCES_DIR/eMark.jar"
if [ ! -f "$JAR_FILE" ]; then
    echo "   ✗ ERROR: eMark.jar not found"
    exit 1
fi
JAR_SIZE=$(du -h "$JAR_FILE" | cut -f1)
echo "   ✓ eMark.jar found (size: $JAR_SIZE)"
echo ""
...
if [ ! -d "$JRE_DIR" ]; then
    ...
    echo "      https://github.com/testaxonatetech/emark/releases/latest"
    echo ""
...
echo "   3. Report the issue at: https://github.com/testaxonatetech/emark/issues"
echo ""
echo "============================================================================"
