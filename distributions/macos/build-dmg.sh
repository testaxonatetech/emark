...
cat > "$DMG_DIR/Install eMark.command" << INSTALLSCRIPT
#!/bin/bash
# ============================================================================
# eMark - macOS Installation Script with Version Checking
# TrexoLab - https://trexolab.com
# ============================================================================
...
echo ""
echo -e "\${BLUE}============================================================================\${NC}"
echo -e "\${BLUE} eMark Installation Script - Version \$NEW_VERSION\${NC}"
echo -e "\${BLUE}============================================================================\${NC}"
echo ""
...
echo -e "\${GREEN}============================================================================\${NC}"
echo ""
echo " You can now launch eMark from your Applications folder."
echo ""
...
INSTALLSCRIPT
chmod +x "$DMG_DIR/Install eMark.command"
...
Option 1: Using the Install Script (Recommended)
   Double-click "Install eMark.command" to run the installer.
   This will:
