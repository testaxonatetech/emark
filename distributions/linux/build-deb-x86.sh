#!/bin/bash
# ============================================================================
# eMark - DEB Package Builder Script (x86/i386)
...
echo "============================================================================"
echo " Building eMark DEB Package (x86/i386)"
echo "============================================================================"
...
cp "$ROOT_DIR/target/eMark.jar" "$PACKAGE_DIR/opt/emark/"
cp "$SCRIPT_DIR/emark-x86" "$PACKAGE_DIR/opt/emark/emark"
chmod +x "$PACKAGE_DIR/opt/emark/emark"

# Copy JRE (x86 version)
echo "Copying bundled JRE (x86)..."
cp -r "$SCRIPT_DIR/jre8-x86" "$PACKAGE_DIR/opt/emark/"
chmod +x "$PACKAGE_DIR/opt/emark/jre8-x86/bin/"*
...
if [ -f "$SCRIPT_DIR/emark.png" ]; then
    ...
    cp "$SCRIPT_DIR/emark.png" "$PACKAGE_DIR/opt/emark/emark.png"
...
Homepage: https://cispl-dev.github.io/emark/
Description: $DESCRIPTION
 eMark is an advanced PDF signing application that supports
...
# Check if eMark is already installed
INSTALLED_VERSION=""

# Check dpkg for installed version
if dpkg -l emark 2>/dev/null | grep -q "^ii"; then
    INSTALLED_VERSION=\$(dpkg-query -W -f='\${Version}' emark 2>/dev/null || echo "")
fi

# Also check for manual installation in /opt/emark
if [ -z "\$INSTALLED_VERSION" ] && [ -f "/opt/emark/version.txt" ]; then
    INSTALLED_VERSION=\$(cat /opt/emark/version.txt 2>/dev/null | tr -d '[:space:]')
fi

if [ -n "\$INSTALLED_VERSION" ]; then
    echo ""
    echo "============================================================================"
    echo " eMark Installation Check (x86/i386)"
    echo "============================================================================"
...
echo "$APP_VERSION" > /opt/emark/version.txt
...
echo ""
echo "============================================================================"
echo " eMark $APP_VERSION (x86/i386) has been installed successfully!"
echo "============================================================================"
echo ""
echo " Launch from:"
echo "   - Applications menu: eMark"
echo "   - Terminal: emark"
echo ""
