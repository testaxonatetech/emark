#!/bin/bash
# ============================================================================
# eMark - DEB Package Builder Script
...
echo "============================================================================"
echo " Building eMark DEB Package"
echo "============================================================================"
...
cp "$SCRIPT_DIR/emark" "$PACKAGE_DIR/opt/emark/"
chmod +x "$PACKAGE_DIR/opt/emark/emark"

# Copy JRE
echo "Copying bundled JRE..."
cp -r "$SCRIPT_DIR/jre8-x64" "$PACKAGE_DIR/opt/emark/"
chmod +x "$PACKAGE_DIR/opt/emark/jre8-x64/bin/"*
...
echo ""
echo "============================================================================"
echo " eMark $APP_VERSION has been installed successfully!"
echo "============================================================================"
echo ""
echo " Launch from:"
