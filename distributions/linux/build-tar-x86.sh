#!/bin/bash
# ============================================================================
# eMark - Portable TAR.GZ Package Builder (x86/i386)
...
echo "============================================================================"
echo " Building eMark Portable Package (tar.gz) - x86/i386"
echo "============================================================================"
...
cp "$ROOT_DIR/target/eMark.jar" "$PACKAGE_DIR/"
...
#!/bin/bash
# ============================================================================
# eMark - Linux Installation Script (x86/i386)
# TrexoLab - https://trexolab.com
# ============================================================================
...
echo ""
echo -e "${BLUE}============================================================================${NC}"
echo -e "${BLUE} eMark Installation Script (x86/i386)${NC}"
echo -e "${BLUE}============================================================================${NC}"
echo ""
...
if command -v dpkg &> /dev/null && dpkg -l emark 2>/dev/null | grep -q "^ii"; then
    INSTALLED_VERSION=$(dpkg-query -W -f='${Version}' emark 2>/dev/null || echo "")
    if [ -n "$INSTALLED_VERSION" ]; then
        echo -e "${YELLOW}Warning: eMark was installed via DEB package.${NC}"
        echo "Please use 'sudo apt remove emark' to uninstall first."
        exit 1
    fi
fi
...
if [ -n "$INSTALLED_VERSION" ]; then
    ...
    if [ $result -eq 1 ]; then
        ...
        echo ""
        echo " Reinstalling eMark $NEW_VERSION..."
    else
    ...
    echo " Installing eMark $NEW_VERSION (x86/i386)..."
fi
...
echo "eMark has been uninstalled."
...
echo ""
echo -e "${GREEN}============================================================================${NC}"
echo -e "${GREEN} eMark $NEW_VERSION (x86/i386) has been installed successfully!${NC}"
echo -e "${GREEN}============================================================================${NC}"
echo ""
echo " Launch from:"
...
echo ""
echo " To uninstall: sudo /opt/emark/uninstall.sh"
echo ""
echo -e "${GREEN}============================================================================${NC}"
INSTALL_EOF
...
============================================================================
 eMark - Portable Linux Package (x86/i386 - 32-bit)
 TrexoLab - https://cispl-dev.github.io/emark/
============================================================================

INSTALLATION:

Option 1: Using the install script (recommended)
   tar -xzf emark-x86-linux.tar.gz
   cd emark-*
   sudo ./install.sh

Option 2: Manual extraction
   tar -xzf emark-x86-linux.tar.gz -C /opt/
   /opt/emark-*/emark
